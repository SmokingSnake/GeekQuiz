...
public class UIStretch : MonoBehaviour
{
	public enum Style
	{
		...
		Both,
		BasedOnHeight,
        FillHorizontalProporcionalVertical,
    ...
    public bool overSizeScreenY;
    public bool overSizeScreenX;
	...
	void Awake ()
	{
        ...
        if (myScreenY > 854)
            overSizeScreenY = true;
        else
            overSizeScreenY = false;

        if (myScreenX > 480)
            overSizeScreenX = true;
        else
            overSizeScreenX = false;
	}
	...
	void Update ()
	{
		...
		if (style != Style.None)
		{
			...
			else
			{
                ...
                if (style == Style.FillHorizontalProporcionalVertical)
                {
                    localScale.x = relativeSize.x * rectWidth;
                    localScale.y = 3 * localScale.x/4;
                }
			}
